...
const ShopCategory = (props) => {
  ...
  return (
    <div className='shop-category items-center gap-2.5 mx-auto my-8'>
      ...
      <div className="explore-more h-8 w-36  md:h-10 md:w-44 lg:h-12 lg:w-60 xl:h-14 xl:w-64 py-6 md:py-6 lg:my-8 xl:my-12 font-semibold flex justify-center items-center mx-auto  rounded-3xl bg-purple-800 text-white hover:bg-purple-700 hover:font-bold hover:duration-300 hover:delay-150 ">
